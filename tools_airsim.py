...
# ---------------------------------------------------------------------------------------------------------------------
class tools_airsim:
    def __init__(self,ip_airsim,camera_rad_yaw_pitch_roll,fov):
        self.fov = fov
...
# ---------------------------------------------------------------------------------------------------------------------
    ...
    def get_airsim_camera_pose(self):
        ...
        orientation = airsim.to_quaternion(pitch, roll, yaw) if UE_ver=='4' else airsim.euler_to_quaternion(roll, pitch, yaw)
...
# ---------------------------------------------------------------------------------------------------------------------
    ...
    def set_fov(self, fov, camera_id="0"):
        ...
        return
    # ---------------------------------------------------------------------------------------------------------------------
    def set_camera_pose(self,position,orientation_cam):
        try:
            self.airsim_client.simSetCameraPose('0',airsim.Pose(airsim.Vector3r(position[0], position[1],-position[2]),airsim.Quaternionr(orientation_cam[0],orientation_cam[1],orientation_cam[2],orientation_cam[3])))
        except Exception as e:
            pass
            #print(f'Error:set_camera_pose')
        return
    # ---------------------------------------------------------------------------------------------------------------------
    ...
    # ----------------------------------------------------------------------------------------------------------------------
    def get_image_new(self, cam='ego'):
        try:
