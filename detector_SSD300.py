...
# ----------------------------------------------------------------------------------------------------------------------
    def process_image(self, image):
        ...
        decoded_predictions = detector_SSD300_core.DecodeDetections(confidence_thresh=0.01,
                                               ...
                                               name='decoded_predictions')(t_predictions)
...
# ----------------------------------------------------------------------------------------------------------------------
    def learn(self,file_annotations, folder_out, folder_annotation=None, limit=4000):
        ...
        images = tools_SSD.get_images(foldername, file_annotations, delim=' ',resized_target=(300, 300))
        ...
        ssd_input_encoder = detector_SSD300_core.SSDInputEncoder(img_height=self.input_image_size[0],
                                            img_width=self.input_image_size[1],
                                            n_classes=len(self.class_names)-1,
        ...
        self.model.fit(x=[images], y=[targets], validation_split=0.3, verbose=2, epochs=100)
